...
theme.set_highlights = function(opts)
	...
	hl(0, 'Search', { fg = isDark and '#11161D' or '#FFFFFF', bg = '#F2CC60', bold = true })
	...
	hl(0, 'Constant', { fg = c.vscBlue, bg = 'NONE', bold = constant_bold, italic = true })
	...
	hl(0, '@constant.builtin', { fg = c.vscBlue, bg = 'NONE', bold = constant_bold, italic = true })
	...
	hl(0, '@namespace', { fg = c.vscBlueGreen, bg = 'NONE', italic = true })
	hl(0, '@module', { fg = c.vscBlueGreen, bg = 'NONE', italic = true })
	hl(0, '@function.builtin', { fg = c.vscYellow, bg = 'NONE', italic = true })
	hl(0, '@function', { fg = c.vscYellow, bg = 'NONE', bold = function_bold })
	hl(0, '@function.macro', { fg = c.vscYellow, bg = 'NONE', italic = true })
	...
	hl(0, '@type.definition', { fg = c.vscBlueGreen, bg = 'NONE' })
	hl(0, '@storageClass', { fg = c.vscBlue, bg = 'NONE', bold = type_bold })
	...
	hl(0, '@variable.member.lua', { fg = c.vscLightBlue, bg = 'NONE' })
	...
	hl(0, 'luaLocal', { fg = c.vscFront, bg = 'NONE' })

...
theme.set_highlights = function(opts)
	...
	local function_bold = opts.bold_functions
	local constant_bold = opts.bold_constants
	...
	hl(0, 'CursorLineNr', { fg = isDark and c.vscYellowOrange or c.vscDarkBlue, bg = c.vscBack, bold = true })
	...
	hl(0, 'Search', { fg = isDark and c.vscBack or '#FFFFFF', bg = c.vscYellowOrange, bold = true })
	...
	hl(0, 'Constant', { fg = c.vscBlue, bg = 'NONE', bold = constant_bold })
	...
	hl(0, 'Statement', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Conditional', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Repeat', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Label', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Operator', { fg = c.vscFront, bg = 'NONE' })
	hl(0, 'Keyword', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Exception', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'PreProc', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Include', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Define', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Macro', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, 'Type', { fg = c.vscBlue, bg = 'NONE', bold = type_bold })
	hl(0, 'StorageClass', { fg = c.vscBlue, bg = 'NONE', bold = type_bold })
	hl(0, 'Structure', { fg = c.vscBlue, bg = 'NONE', bold = type_bold })
	hl(0, 'Typedef', { fg = c.vscBlue, bg = 'NONE', bold = type_bold })
	...
	hl(0, '@comment', { fg = c.vscGreen, bg = 'NONE', italic = opts.italic_comments })
	hl(0, '@constant', { fg = c.vscYellow, bg = 'NONE', italic = true, bold = constant_bold })
	hl(0, '@constant.builtin', { fg = c.vscBlue, bg = 'NONE', bold = true, italic = true })
	hl(0, '@constant.macro', { fg = c.vscBlueGreen, bg = 'NONE', bold = constant_bold, italic = true })
	...
	hl(0, '@boolean', { fg = c.vscBlue, bg = 'NONE' })
	hl(0, '@float', { fg = c.vscLightGreen, bg = 'NONE' })
	hl(0, '@annotation', { fg = c.vscYellowOrange, bg = 'NONE', italic = true })
	hl(0, '@attribute', { fg = c.vscYellowOrange, bg = 'NONE', italic = true })
	hl(0, '@namespace', { fg = c.vscBlueGreen, bg = 'NONE', bold = type_bold })
	hl(0, '@module', { fg = c.vscBlueGreen, bg = 'NONE', bold = type_bold })
	hl(0, '@function.builtin', { fg = c.vscYellow, bg = 'NONE', bold = true, italic = true })
	hl(0, '@function', { fg = c.vscYellow, bg = 'NONE', bold = function_bold })
	hl(0, '@function.macro', { fg = c.vscYellow, bg = 'NONE', bold = true, italic = true })
	hl(0, '@parameter', { fg = c.vscLightBlue, bg = 'NONE', italic = parameter_italic })
	hl(0, '@parameter.reference', { fg = c.vscLightBlue, bg = 'NONE', italic = parameter_italic })
	hl(0, '@method', { fg = c.vscYellow, bg = 'NONE', bold = function_bold })
	hl(0, '@function.method', { fg = c.vscYellow, bg = 'NONE', bold = function_bold })
	hl(0, '@field', { fg = c.vscLightBlue, bg = 'NONE' })
	hl(0, '@property', { fg = c.vscLightBlue, bg = 'NONE' })
	hl(0, '@constructor', { fg = c.vscBlueGreen, bg = 'NONE', bold = true })
	hl(0, '@conditional', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@repeat', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@label', { fg = c.vscLightBlue, bg = 'NONE' })
	hl(0, '@keyword', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@keyword.function', { fg = c.vscBlue, bg = 'NONE', italic = keyword_italic })
	hl(0, '@keyword.operator', { fg = c.vscBlue, bg = 'NONE', italic = keyword_italic })
	hl(0, '@keyword.import', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@keyword.return', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@keyword.conditional', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@keyword.repeat', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@keyword.exception', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@operator', { fg = c.vscFront, bg = 'NONE' })
	hl(0, '@exception', { fg = c.vscPink, bg = 'NONE', italic = keyword_italic })
	hl(0, '@type', { fg = c.vscBlueGreen, bg = 'NONE', bold = type_bold })
	hl(0, '@type.builtin', { fg = c.vscBlue, bg = 'NONE', bold = type_bold })
	hl(0, '@type.qualifier', { fg = c.vscBlue, bg = 'NONE', italic = keyword_italic })
	hl(0, '@type.definition', { fg = c.vscBlueGreen, bg = 'NONE', bold = true })
	hl(0, '@storageClass', { fg = c.vscBlue, bg = 'NONE', bold = type_bold })
